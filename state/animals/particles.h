...
struct startdata{
	...
	void rebuild(){
		...
		;
		  c.rebuild();
		  fss2.rebuild("statedata/animals/test.frag");
	...
	startdata() : reload(false), pointcount(180000), fss2("statedata/animals/test.frag"), fss("statedata/animals/output.frag")
	...
	last(0)
	{
		clp = "builtins/tools.cl statedata/animals/save/particleengine.cl";
