...
struct startdata{
	...
	void rebuild(){
		  ...
		  p1.rebuild("statedata/animals/minimal1.frag","statedata/animals/minimal1.geom","statedata/animals/minimal1.vert")
		, p2.rebuild("statedata/animals/minimal2.frag","statedata/animals/minimal2.geom","statedata/animals/minimal2.vert")
		, p4.rebuild("statedata/animals/minimal4.frag","statedata/animals/minimal4.geom","statedata/animals/minimal4.vert")
		;
		  c.rebuild();
		  fss2.rebuild("statedata/animals/save/testb.frag");
		  fss.rebuild("statedata/animals/output.frag");
		  fb.colorbuffer(0, t);
		  fb.colorbuffer(1, t1);
		  fb.colorbuffer(2, t2);
		  fb.depthbuffer(t3);
	...
	startdata() : reload(false), pointcount(180000), fss2("statedata/animals/save/testb.frag"), fss("statedata/animals/output.frag")
	,p1("statedata/animals/minimal1.frag","statedata/animals/minimal1.geom","statedata/animals/minimal1.vert")
	,p2("statedata/animals/minimal2.frag","statedata/animals/minimal2.geom","statedata/animals/minimal2.vert")
	...
	last(0)
	{
		...
		cll = "builtins/tools.cl statedata/animals/clline.cl";
...
class particles2 : public shiva::behaviour {
