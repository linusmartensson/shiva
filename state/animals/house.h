...
struct startdata{
	...
	void rebuild(){
		  ...
		  p1.rebuild("statedata/animals/house/minimal1.frag","statedata/animals/house/minimal1.geom","statedata/animals/house/minimal1.vert")
		, p2.rebuild("statedata/animals/house/minimal2.frag","statedata/animals/house/minimal2.geom","statedata/animals/house/minimal2.vert")
		, p4.rebuild("statedata/animals/minimal4.frag","statedata/animals/minimal4.geom","statedata/animals/minimal4.vert")
		;
		  c.rebuild();
		  fss2.rebuild("statedata/animals/house/test.frag");
		  mimg.rebuild();
		  fss.rebuild("statedata/animals/house/output.frag");
		  fb.colorbuffer(0, t);
		  fb.colorbuffer(1, t1);
		  fb.colorbuffer(2, t2);
		  fb.depthbuffer(t3);
	...
	startdata() : reload(false), pointcount(600000), fss("statedata/animals/house/output.frag"),
	fss2("statedata/animals/house/test.frag")
	,mimg("statedata/animals/musehouse.png")
	,p1("statedata/animals/house/minimal1.frag","statedata/animals/house/minimal1.geom","statedata/animals/house/minimal1.vert")
	,p2("statedata/animals/house/minimal2.frag","statedata/animals/house/minimal2.geom","statedata/animals/house/minimal2.vert")
	...
	last(0)
	{
		clp = "builtins/tools.cl statedata/animals/house/particleengine.cl";
		cll = "builtins/tools.cl statedata/animals/house/clline.cl";
...
class house : public shiva::behaviour {
	...
	virtual void render(shiva::childvec children, boost::any &data) const {
		...
		d.fss2.program().bindTexture("house", d.t4, 0);
