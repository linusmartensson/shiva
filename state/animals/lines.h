...
struct startdata{
	...
	void rebuild(){
		...
		;
		  c.rebuild();
		  fss.rebuild("statedata/animals/lines/output.frag");
		  fb.colorbuffer(0, t);
		  fb.colorbuffer(1, t1);
		  fb.colorbuffer(2, t2);
		  fb.depthbuffer(t3);
	...
	startdata() : reload(false), pointcount(20000), fss("statedata/animals/lines/output.frag")
	...
	last(0)
	{
		...
		cll = "builtins/tools.cl statedata/animals/lines/clline.cl";
...
class lines : public shiva::behaviour {
